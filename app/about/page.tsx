...
const page = () => {
  return (
    <div>
      <AboutHero />
      <div className="bg-neutral-50 py-22 flex justify-center gap-8">
        <div className="flex flex-col gap-3 max-w-xl">
          ...
          <article className="text-neutral-600 leading-8">
            Trip Pilot was born from a simple frustration: planning trips
            shouldn&apos;t be harder than the trips themselves.
            Me and other travelers who spent countless hours juggling spreadsheets and

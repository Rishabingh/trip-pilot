...
const FeatureHero = () => {
  return (
    <div className='md:py-22 py-10 flex flex-col justify-center items-center'>
        <div className="font-bold md:text-5xl text-4xl md:leading-20 text-center md:text-left">
          Powerful Features for <span className="bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Seamless Travel Planning</span>
        </div>
